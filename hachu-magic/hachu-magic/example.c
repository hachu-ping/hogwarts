...
int main()
{
    ...
    must_init(al_init_image_addon(), "image"); //png와 jpeg를 사용할 수 있게됩니다 확장자?
    sprites_init();

    hud_init();

    must_init(al_init_primitives_addon(), "primitives");  //기본그리기? 도구들 사용
